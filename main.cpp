...
int main(int argc, char *argv[]){
	...
	//random
	} else if ((strcmp(argv[2], "r" ) == 0) || (strcmp(argv[2], "--random")) == 0) {
		for (int i = 0; i < count; ++i){
	...
	//hybrid
	} else if ((strcmp(argv[2], "hy")) == 0 || (strcmp(argv[2], "--hybrid")) == 0){
		for (int i = 0; i < count; ++i){
	...
	} else if ((strcmp(argv[2], "a")) == 0 || (strcmp(argv[2], "--all")) == 0){
		for (int i = 0; i < count; ++i){
